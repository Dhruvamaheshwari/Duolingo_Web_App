    ...
    <div className="flex min-h-screen flex-col bg-[#f7f9fa] font-sans text-gray-800 dark:text-gray-100">
      ...
      <header className="sticky top-0 z-10 flex h-16 w-full items-center justify-between border-b-2 border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-900 px-4 md:px-8">
        ...
        <div className="flex items-center gap-6 font-bold text-gray-500 dark:text-gray-400">
          ...
          <span className="text-gray-800 dark:text-gray-100 border-b-2 border-gray-800 pb-1">PROFILE</span>
        </div>
      </header>
      ...
      <main className="mx-auto flex w-full max-w-2xl flex-col items-center py-10 px-4">
        ...
        {/* Profile Card */}
        <div className="w-full mb-10 rounded-2xl border-2 border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-8 shadow-sm text-center">
          ...
          <h1 className="text-3xl font-extrabold text-gray-800 dark:text-gray-100">{progress.username || 'Learner'}</h1>
          <p className="text-gray-500 dark:text-gray-400 font-bold mt-2">Joined recently</p>
        </div>

        {/* Stats Grid */}
        <div className="w-full grid grid-cols-2 gap-4 mb-10">
          <div className="rounded-2xl border-2 border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-6 shadow-sm flex gap-4 items-center">
            <span className="text-4xl">⚡</span>
            <div>
              <p className="text-2xl font-bold text-gray-800 dark:text-gray-100">{progress.total_xp}</p>
              <p className="text-sm font-bold text-gray-500 dark:text-gray-400 uppercase">Total XP</p>
            </div>
          </div>
          <div className="rounded-2xl border-2 border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-6 shadow-sm flex gap-4 items-center">
            <span className="text-4xl">🔥</span>
            <div>
              <p className="text-2xl font-bold text-gray-800 dark:text-gray-100">{progress.current_streak}</p>
              <p className="text-sm font-bold text-gray-500 dark:text-gray-400 uppercase">Day Streak</p>
            </div>
          </div>
          <div className="rounded-2xl border-2 border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-6 shadow-sm flex gap-4 items-center">
            <span className="text-4xl">📚</span>
            <div>
              <p className="text-2xl font-bold text-gray-800 dark:text-gray-100">{completedLessons}</p>
              <p className="text-sm font-bold text-gray-500 dark:text-gray-400 uppercase">Lessons Finished</p>
            </div>
          </div>
          <div className="rounded-2xl border-2 border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-6 shadow-sm flex gap-4 items-center">
            <span className="text-4xl">👑</span>
            <div>
              <p className="text-2xl font-bold text-gray-800 dark:text-gray-100">{completedSkills}</p>
              <p className="text-sm font-bold text-gray-500 dark:text-gray-400 uppercase">Skills Mastered</p>
            </div>
          </div>
        </div>

        {/* Daily Goal Widget */}
        <div className="w-full rounded-2xl border-2 border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-6 shadow-sm">
